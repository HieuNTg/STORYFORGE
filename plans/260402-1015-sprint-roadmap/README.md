# StoryForge Sprint Roadmap (Sprint 7-12)
**Created:** 2026-04-02 | **Owner:** CTO | **Status:** Active
**Project Type:** Open Source

## Overview
Post-evaluation roadmap: Alpha → Production-ready → Public Release (Open Source).

## Sprint Timeline

| Sprint | Focus | Duration | Goal | Status |
|--------|-------|----------|------|--------|
...
|--------|----------|----------|----------|-----------|-----------|-----------|
| Backend | DB migration | API versioning | Redis rate limiter | - | LLM optimization | Bug fixes |
| Frontend | - | Vite build | - | Feedback UI | UX + Dark mode | Docs polish |
| AI/ML | - | - | Eval benchmark | - | Scoring calibration | - |
| DevOps | Prod deploy | Monitoring | Load testing | Setup scripts | - | Release + Demo |
| Security | - | JWT + Audit | Dep scan | - | Pen testing | SECURITY.md |
| QA | - | - | Coverage + Load | - | Regression suite | Launch checklist |
| PM | Planning | - | - | README + Docs | Plugin docs | Community launch |
