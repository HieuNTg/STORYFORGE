...
def build_dialogue_context(characters: list[Character], genre: str) -> str:
    ...
    lines.append(
        "- Mỗi dòng đối thoại phải reveal tính cách HOẶC advance plot (tốt nhất là cả hai)"
    )
...
def get_speech_pattern_reminder(
    character_name: str, characters: list[Character]
) -> str:
