...
# rhythm/continuity/voice). Plot/character/drama changes belong to the
# DramaSimulator (`pipeline/layer2_enhance/simulator.py`). See plan
# `plans/260505-1146-simulator-debate-contract/` for the full policy.
CRAFT_LANE_BOUNDARY = (
    "PHẠM VI: Bạn là editor critique craft (pacing, prose, dialogue rhythm, "
    "continuity, voice). KHÔNG được đề xuất thay đổi plot, character motivation, "
    "drama, hay conflict mới. Nếu thấy vấn đề plot, ghi chú trong `issues` nhưng "
    "KHÔNG đưa vào `suggestions`."
)
