...
_CRAFT_PATTERNS = [
    ...
    r"\bsentence length\b",
    r"\btelling not showing\b",
    r"\bshow.{0,3}don'?t tell\b",
    r"\bshow vs\.? tell\b",
    r"\bshow,? not tell\b",
    r"\bvăn xuôi\b",
    r"\bphép so sánh\b",
    ...
    r"\bmetaphor\b",
    r"\bsimile\b",
    r"\bdescription quality\b",
    r"\bmiêu tả\b",
    r"\bvoice consistency\b",
    r"\btone consistency\b",
    r"\bdialogue tag\b",
    r"\bdialogue attribution\b",
    r"\bpacing of prose\b",
    r"\bsentence flow\b",
    r"\bpunctuation\b",
    r"\bdấu câu\b",
    r"\bchấm câu\b",
    r"\bperspective shift\b",
    r"\bpov shift\b",
    r"\bhead-?hopping\b",
    r"\btense shift\b",
    r"\bnarrative voice\b",
    r"\brepetitive\b",
    r"\bredundant\b",
    r"\bclarity\b",
    r"\bawkward phrasing\b",
]
