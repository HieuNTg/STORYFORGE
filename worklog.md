...
- **Stage Summary**: smart revision service now respects the 200-line rule with stateless agent-review aggregation isolated in an internal module. 250–270L band remaining: pipeline/layer1_story/chapter_contract_builder.py (265), pipeline/layer1_story/consistency_validators.py (268). Commit `<pending>`.
