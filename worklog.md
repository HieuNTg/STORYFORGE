...
- **Stage Summary**: chapter contract builder now respects the 200-line rule with the pure-Python assembly + event-matching isolated in an internal module. 250–270L band remaining: pipeline/layer1_story/consistency_validators.py (268). Commit `<pending>`.
